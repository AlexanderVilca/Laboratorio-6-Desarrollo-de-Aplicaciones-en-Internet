    ...
    <div class="container">
        <div class="card mt-5">
            <div class="card-header text-center bg-info text-dark">
                <h3><div>Matricula agregadad</div></h3>
            </div>
            ...
            <h3>
                <?php
                    ...
                    if(!$resultado){
                        echo 'La matricula no pudo ser registrada';
                    } else {
                        echo 'La matricula fue registrada exitosamente';
                    }
                ?>
            </h3>
            <a href="matriculas.php"><button type="submit" class="btn btn-primary"> Regresar </button></a>
            </div>
        </div>
    </div>
