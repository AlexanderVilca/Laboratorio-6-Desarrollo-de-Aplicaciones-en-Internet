    ...
    <div class="container">
        <div class="card mt-5">
            <div class="card-header text-center bg-info text-dark">
                <h3><div>Alumno Actualizado</div></h3>
            </div>
            ...
            <h3>
                <?php
                    ...
                    if(!$resultado){
                        echo 'El alumno no se logro actualizar';
                    } else {
                        echo 'El alumno fue actualizado exitosamente';
                    }
                ?>
            </h3>
            <a href="alumnos.php"><button type="button" class="btn btn-primary"> Regresar </button></a>
            </div>
        </div>
    </div>
